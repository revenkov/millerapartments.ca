    ...
    <footer class="newsletter">
        <div class="container">
            <div class="newsletter__inner">
                <div class="newsletter__col1">
                    <h2>Sign Up for Our Newsletter</h2>
                </div>

                <div class="newsletter__col2">
                    <form action="" class="newsletter__form" id="newsletterForm">
                        <input type="hidden" name="action" value="newsletter_form">
                        <div class="formFields">
                            <div class="fieldBlock fieldBlock--fullWidth">
                                <label class="screen-reader-text" for="email2">Email</label>
                                <input id="email2" type="email" name="email" value="" placeholder="Email" autocomplete="email" required>
                            </div>
                        </div>
                        <div class="formButtons">
                            <button class="btn btn--hoverWhite">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    */ ?>
    ...
    <footer id="footer" class="siteFooter" role="contentinfo">
        <div class="container">
            <div class="siteFooter__cols">
                ...
                <div class="siteFooter__col2">
                    ...
                    <div class="siteFooter__contacts">
                        <?php if ( !empty( $address ) ) : ?><div class="siteFooter__address"><a href="<?php echo $google_map_link; ?>" target="_blank"><?php echo $address; ?></a></div><?php endif; ?>
                        <?php if ( !empty( $email ) ) : ?><div class="siteFooter__email"><span class="siteFooter__label">E</span> <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></div><?php endif; ?>
                        <?php if ( !empty( $phone ) ) : ?><div class="siteFooter__phone"><span class="siteFooter__label">T</span> <a href="tel:+1<?php echo preg_replace("/[^0-9]/", "", $phone); ?>"><?php echo $phone; ?></a></div><?php endif; ?>
                    </div>
                    <div class="siteFooter__socials">
                        <div class="siteFooter__socialsTitle">Follow Glendelle Retirement Living</div>
                        <div class="siteFooter__socialsLinks">
                            ...
                            <?php endif; ?>
                            <?php if ( !empty( $tiktok ) ) : ?>
                            <a href="<?php echo $tiktok; ?>" title="Tik Tok" target="_blank">
            ...
            <div class="siteFooter__copyright">Copyright&copy; <?php echo date('Y'); ?>. All rights reserved. All illustrations are artist concept.<br> Map is not to scale. Specifications subject to change without notice. E. & O. E. <span class="siteFooter__pipe">|</span> <a href="<?php echo selectrum_get_permalink( 2558 ); ?>">Privacy Policy</a></div>
        </div>
    </footer>
