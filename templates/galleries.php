...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    ?>
    <section class="section sectionGalleries">
        <div class="container">
                        ...
                        <?php while ( $query->have_posts() ) :
                            ...
                            <div class="teaserNews">
                                ...
                                <div class="teaserNews__overlay">
                                    ...
                                    <a class="btn btn--hoverWhite" href="<?php the_permalink(); ?>">View more</a>
                                </div>
                                <a class="teaserNews__lnkOverlay" href="<?php echo get_the_permalink(); ?>" title="<?php _e('View more', 'selectrum'); ?>"></a>
                            </div>
